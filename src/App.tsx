  ...
  <section className="relative bg-primary overflow-hidden py-20 lg:py-32">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      <div className="text-center max-w-3xl mx-auto">
        ...
        >
          <div className="inline-flex items-center justify-center px-6 py-2 rounded-full border border-white/35 bg-white/10 text-white text-xs sm:text-sm font-extrabold uppercase tracking-[0.2em] mb-8">
            COURTIER INDEPENDANT . VAL DE MARNE (94)
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-10">
          <div className="md:col-span-2 lg:col-start-2 lg:col-span-2">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow px-4 py-5 sm:px-5 sm:py-6 md:px-6 md:py-6">
              <div className="flex flex-col md:flex-row items-center gap-5 md:gap-6">
                <div className="relative w-14 h-14 rounded-xl bg-soft text-primary flex items-center justify-center flex-shrink-0">
                  <ShieldCheck className="w-8 h-8" strokeWidth={1.75} />
                  <span className="absolute -bottom-0.5 -right-0.5 w-7 h-7 rounded-lg bg-white border border-gray-100 flex items-center justify-center text-primary shadow-sm">
                    <KeyRound className="w-4 h-4" strokeWidth={2.25} />
                  </span>
                </div>
                <div className="flex-1 min-w-0 text-center md:text-left">
                  <h4 className="text-base sm:text-lg font-bold text-primary leading-snug mb-2">
                    Prêt(e) à économiser jusqu&apos;à 15&nbsp;000&nbsp;€ sur votre Assurance Emprunteur ?
                  </h4>
                  <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
                    Nous avons négocié des conditions préférentielles pour votre assurance emprunteur.
                  </p>
                </div>
                <button
                  type="button"
